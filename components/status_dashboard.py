...
.dashboard-body {{ grid-template-columns: 1fr; gap: 24px; }}
.total-section {{ border-right: none; border-bottom: 1px solid rgba(255, 255, 255, 0.08); padding-right: 0; padding-bottom: 24px; }}
